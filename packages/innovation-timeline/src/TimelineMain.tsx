...
import { Tabs, TabsContent, TabsList, TabsTrigger } from "@rights/ui/tabs"
...
import { Card, CardContent } from "@rights/ui/card"
...
export default function InnovationTimelines() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-background via-background to-muted/20">
      ...
      <header className="sticky top-16 z-40 w-full border-b bg-background/80 backdrop-blur-xl supports-[backdrop-filter]:bg-background/60 shadow-lg">
